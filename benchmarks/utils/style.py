...
MODEL_COLORS: dict[str, str] = {
    ...
    "BDF-Core": _BDF,
    "bdf_normalmunormal_nle": _BDF,
    "bdf_betamvbernoulli_nle": _BDF,
    "bdf_full_clas": _BDF,
    "bdf_normalmunormal_nll": _BDF,
    "bdf_normalmunormal_nll_bic": _BDF,
    "bdf_freqstudentt_nll": _BDF_VARIANT,
    "bdf_freqstudentt_nll_bic": _BDF_VARIANT,
    "BDFKDE": _BDF_VARIANT,
    ...
    "ngboost_laplace": _NGBOOST,
    "ngboost_lognormal": _NGBOOST,
    "ngboost_exponential": _NGBOOST,
    "ngboost_poisson": _NGBOOST,
...
MODEL_DISPLAY_NAMES: dict[str, str] = {
    ...
    "bdf_normalmunormal_nle": "BDF-Normal NLE",
    "bdf_betamvbernoulli_nle": "BDF-Bernoulli NLE",
    "bdf_full_clas": "BDF-Full",
    "bdf_normalmunormal_nll": "BDF-Normal NLL",
    "bdf_normalmunormal_nll_bic": "BDF-Normal NLL+BIC",
    "bdf_freqstudentt_nll": "BDF-$t$ NLL",
    "bdf_freqstudentt_nll_bic": "BDF-$t$ NLL+BIC",
    "bdf_kde": "BDF (KDE)",
    ...
    "lgbm_qreg": "LGBM-QR",
    "ngboost_reg": "NGBoost",
    "ngboost_normal": "NGBoost-Normal",
    "ngboost_laplace": "NGBoost-Laplace",
    "ngboost_lognormal": "NGBoost-LogNormal",
    "ngboost_exponential": "NGBoost-Exponential",
